"""
This script was modified from https://github.com/peteryuX/arcface-tf2/blob/master/modules/evaluations.py
"""
import os
import cv2
import bcolz
...
def get_val_data(data_path):
    """get validation data"""
    lfw, lfw_issame = get_val_pair(data_path, os.path.join('lfw_align_112', 'lfw'))
    agedb_30, agedb_30_issame = get_val_pair(data_path, os.path.join('agedb_align_112', 'agedb_30'))
    cfp_fp, cfp_fp_issame = get_val_pair(data_path, os.path.join('cfp_align_112', 'cfp_fp'))
